 ...
 *
 * It spawns a set of UCultureSwitcherButtonWidget buttons, that represents all found localizaed
 * cultures. Each one of these buttons is capable of switching current culture to the one assigned
 * to this button.
 */
UCLASS()
class SHARED_API UCultureSwitcherPanelWidget : public UUserWidget
{
	GENERATED_BODY()
